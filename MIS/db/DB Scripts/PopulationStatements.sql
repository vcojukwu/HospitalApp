...
INSERT INTO `mis_db`.`patients` (`PatientId`, `DoctorId`, `HealthStateId`, `HealthCardNumber`, `SocialInsuranceNumber`, `NumberOfVisits`, `IsActive`, `LastVisitDate`, `PatientNotes`) VALUES ('patient3@email.com', 'doctor5@email.com', '3', '2315657', '616834462', '31', 1, NOW(), 'Patient is feeling motion sickness.');
INSERT INTO `mis_db`.`patients` (`PatientId`, `DoctorId`, `HealthStateId`, `HealthCardNumber`, `SocialInsuranceNumber`, `NumberOfVisits`, `IsActive`, `LastVisitDate`, `PatientNotes`) VALUES ('patient4@email.com', 'doctor2@email.com', '4', '4549835', '987844526', '64', 1, NOW(), 'Prescribing antidote.');
INSERT INTO `mis_db`.`patients` (`PatientId`, `DoctorId`, `HealthStateId`, `HealthCardNumber`, `SocialInsuranceNumber`, `NumberOfVisits`, `IsActive`, `LastVisitDate`, `PatientNotes`) VALUES ('patient5@email.com', 'doctor4@email.com', '2', '2256432', '132133548', '5', 0, NOW(), 'Patient deceased.');
INSERT INTO `mis_db`.`patients` (`PatientId`, `DoctorId`, `HealthStateId`, `HealthCardNumber`, `SocialInsuranceNumber`, `NumberOfVisits`, `IsActive`, `LastVisitDate`, `PatientNotes`) VALUES ('patient6@email.com', 'doctor7@email.com', '9', '6213147', '112121658', '2', 1, NOW(), 'Patient experiencing symptoms of Alziemers.');
INSERT INTO `mis_db`.`patients` (`PatientId`, `DoctorId`, `HealthStateId`, `HealthCardNumber`, `SocialInsuranceNumber`, `NumberOfVisits`, `IsActive`, `LastVisitDate`, `PatientNotes`) VALUES ('patient7@email.com', 'doctor1@email.com', '6', '3212554', '416641325', '64', 1, NOW(), 'Fracture to left ankle.');
...
INSERT INTO `mis_db`.`address` (`StreetNumber`, `StreetName`, `City`, `Province`, `Country`, `PostalCode`) VALUES ('65', 'Baller Square', 'Burlington', 'ON', 'CAN', 'K3I2O4');
...
INSERT INTO `mis_db`.`staff_doctor` (`StaffId`, `DoctorId`) VALUES ('staff1@email.com', 'doctor1@email.com');

INSERT INTO `mis_db`.`appointments` (`PatientId`, `DoctorId`, `TimeScheduled`, `DurationScheduled`) VALUES ('patient1@email.com', 'doctor1@email.com', '2014-11-24 12:30:00', '60');
INSERT INTO `mis_db`.`appointments` (`PatientId`, `DoctorId`, `TimeScheduled`, `DurationScheduled`) VALUES ('patient2@email.com', 'doctor1@email.com', '2014-11-30 09:30:00', '30');
